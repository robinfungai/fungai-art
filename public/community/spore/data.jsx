...
const EVENTS = [
  ...
  {
    id: 'fungi-fever-fest-1010',
    title: 'Fungi Fever Fest',
    subtitle: 'Holzmarkt · Berlin · Two-day festival',
    date: '2026-10-10',
    time: '12:00',
    node: 'berlin',
    freq: '432 Hz',
  ...
  {
    id: 'fff-dinner-1011',
    title: 'FFF Dinner Experience',
    subtitle: 'Holzmarkt · Berlin · Sun evening of Fungi Fever Fest',
    date: '2026-10-11',
    time: '19:00',
    node: 'berlin',
    freq: '111 Hz',
    color: '#C4872A',
    capacity: 50,
    desc: 'Seven-course fungal feast by forager-chef Robin Floræsta, hosted as the closing evening of Fungi Fever Fest. Foraged Nordic mushrooms, adaptogens, ceremonial amanita micro-drop. €77 early bird. Reserve at /dinner-experience/#reserve.',
    url: '/dinner-experience/',
    contributions: [
      { type: 'kitchen',    earn: 120, rep: 3, label: 'Kitchen brigade for the dinner' },
      { type: 'events',     earn: 80,  rep: 2, label: 'Front-of-house & service' },
      { type: 'laboratory', earn: 60,  rep: 1, label: 'Ally prep · amanita micro-dose' },
    ],
    open: true,
    partOf: 'fungi-fever-fest-1010',
  },
  {
