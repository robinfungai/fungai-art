...
const LAND = [
  ...
  // Asia mainland — outline runs along the *top* of Arabia + Iran +
  // Pakistan rather than dipping into India. India is its own polygon
  // below so the peninsula reads as a peninsula, not a coastline blob.
  [[25,42],[28,44],[32,42],[36,40],[40,38],[46,38],[52,38],[58,38],[62,36],[64,30],[66,28],[68,26],[72,28],[78,30],[84,30],[88,28],[92,24],[96,22],[100,20],[104,14],[106,12],[108,10],[112,12],[116,16],[120,22],[124,28],[128,32],[132,38],[136,42],[140,45],[145,48],[148,52],[145,56],[138,60],[120,68],[100,72],[80,74],[60,72],[45,71],[36,68],[30,65],[26,58],[24,52],[25,46],[25,42]],
  // Indian subcontinent — proper peninsula shape (Mumbai bulge on west,
  // Bengal indent on east, Cape Comorin at the southern tip, Himalaya
  // wedge into the mainland at the top).
  [[68,24],[70,22],[72,19],[73,16],[75,12],[76.5,9],[77.5,8],[79,8.5],[80,10],[80.5,13],[82,15],[84,18],[86,20.5],[87,22],[88,23.5],[90,23],[92,22],[91,25],[88,26.5],[85,27],[81,28],[77,30],[74,31],[71,30],[69,28],[67,26],[68,24]],
  // Arabian peninsula — Yemen + Oman + Saudi + UAE. Red Sea on the
  // west, Persian Gulf on the NE, Arabian Sea south. Bab-el-Mandeb at
  // (43,12) anchors the Yemen tip.
  [[35,29],[37,28],[40,24],[42,21],[43,17],[43,13],[45,12.7],[48,13],[51,15],[54,17],[56,20],[59,22],[57,24],[54,25.5],[51,26],[50,27],[49,28.5],[48,29],[47,30],[45,29],[42,29],[39,29],[37,29.5],[35,29]],
  // South America — fuller outline so the continent actually reads as
  // South America: Venezuela / Guianas north coast, NE Brazil bulge,
  // SE Brazil indent, Río de la Plata, Patagonia narrowing to Cape
  // Horn, then up the Pacific (Chile coast tight, Peru, Ecuador, Colombia).
  [[-79.5,8.5],[-77,7.5],[-74,11],[-71,12],[-67,11],[-62,10],[-58,8],[-53,5],[-49,1],[-45,-1],[-41,-3],[-38,-5],[-35,-8],[-34.8,-11],[-37,-15],[-38.5,-19],[-40,-23],[-43,-23.5],[-46,-25],[-48.5,-26.5],[-51,-30],[-54,-33],[-57,-35],[-58,-37],[-61,-38.5],[-63,-41],[-64,-43],[-65.5,-45],[-67,-48],[-68,-50],[-69,-52],[-71,-53.5],[-72,-54.5],[-73,-53],[-73.5,-50],[-73.5,-46],[-74,-42],[-73,-38],[-73,-34],[-72,-30],[-71,-25],[-70.5,-20],[-71,-17],[-72,-13],[-76,-10],[-78,-8],[-80,-5],[-81,-2],[-80.5,1],[-79,3],[-78,5],[-79.5,8.5]],
