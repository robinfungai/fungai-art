...
const EXCLUSIVE = [
  ...
  {
    id:'ex5', name:'Dinner Ceremony Gummy',
    sub:'Pre-dinner · grounding',
    badge:'EVENT ONLY',
    bg:'#0F1820',
    accent:'#6BD66F',
    desc:'Developed for the Fungai Art Dinner Experience. Cordyceps + Reishi + L-theanine base. Calms CNS without sedation, opens taste and scent perception before the first course.',
    note:'Take 45 min before dinner. One gummy.',
    pEur:12, pH:9,
    vol:'6 gummies',
    season:'Dinner Experience events only',
  },
  {
