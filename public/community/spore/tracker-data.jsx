...
const TrackerData = (() => {
  ...
  const SEED_CONTRIBUTIONS = [
    ...
    { id:'c-6',  memberId:'sorrel', typeId:'workshop', nodeId:'genoa',  notes:'Extract-making intensive · 6 students',                                            status:'approved', submittedAt:days(12), reviewedAt:days(11), reviewedBy:'birch' },
