...
function getDeviceId(): string {
  ...
  if (!id) {
    ...
    localStorage.setItem("fungai_device_id", id);
  }
  return id;
}
...
const METHOD_COLOR: Partial<Record<ExtractionMethod, { text: string; bg: string; border: string }>> = {
  ...
  distillation:    { text: "#93c5fd", bg: "rgba(147,197,253,0.12)",  border: "rgba(147,197,253,0.35)"  },
  "cryo-maceration": { text: "#f9a8d4", bg: "rgba(249,168,212,0.12)", border: "rgba(249,168,212,0.35)" },
};
